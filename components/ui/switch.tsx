...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "bg-slate-100 data-[state=checked]:bg-black",
      className
    )}
    {...props}
    ref={ref}
  >
    <SwitchPrimitives.Thumb
      className={cn(
        ...
        "bg-slate-100 data-[state=checked]:bg-slate-100 data-[state=unchecked]:border data-[state=unchecked]:border-slate-600",
