...
const SidebarItem = ({ item, pageName, setPageName, compactView }: any) => {
  const handleClick = () => {
    ...
    <>
      <li className="relative">
        <Link
          ...
          } rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4`}
        >
